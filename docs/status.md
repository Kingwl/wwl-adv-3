...
- 战斗基础决策反馈补强：选中攻击牌会在敌阵标记精准/可能命中目标，手牌标题显示手牌、抽牌堆和弃牌堆数量；不可用卡保持可点并显示费用不足/无目标等原因，点击后会触发法力 HUD 闪烁和飘字反馈；遭遇开始、战斗胜利和冒险结束会播放短过渡字卡。
...
2. 继续补基础体验高收益项：战斗音效/轻震、地图移动 tween、奖励卡依次弹入和收入牌组反馈。
