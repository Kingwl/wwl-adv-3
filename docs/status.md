...
- 核心奖励选择第一版：第 1 关升级奖励可基于 seed 生成 3 个不重复卡牌选项，并能把所选卡牌加入 run deck；升级后会进入 reward 模式，选择奖励后才回到探索。
...
- 升级奖励 UI：战斗胜利触发升级时显示 3 个卡牌奖励选项，支持鼠标 hover/点击、左右/A/D 切换和空格/回车确认，选择后加入牌组并回到探索。
